...
import {
  ...
  GitCompareArrows, LogOut, ChevronLeft, ChevronRight, ChevronDown, ChevronUp,
  FolderOpen
} from "lucide-react";

const userMenu = [
  { path: "/", label: "Quản lý KPI", icon: FolderOpen },
];

const adminSubMenu = [
  { path: "/", label: "Tổng quan", icon: LayoutDashboard },
  { path: "/kpi/manage", label: "Thống kê KPI", icon: Settings },
        ...
        {!isAdmin ? (
          ...
          <div>
            <button
              ...
              className="flex items-center justify-between w-full px-3 py-2.5 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200"
            >
              <div className="flex items-center gap-3">
                <FolderOpen size={20} className="text-gray-500 flex-shrink-0" />
